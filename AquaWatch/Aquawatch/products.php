...
<body>
  ...
  <div class="container ">
    <h1 class="text-center font-80px margin-bottom50"> <b>Welcome <?php echo $_SESSION['name']; ?>, Try our new collection!</b></h1>
        ...
        while($row=mysqli_fetch_assoc($result))
        {
          echo '<div class="col-md-3">
                  <div class="product-tab">
                    ...
                    <h3 class="text-center"><p>₹<b>'.$row['product_price'].'</b></p></h3>
        ...
        <div class="row">
          ...
          <div class="col-md-12 bio-tab">
            <div class="row">
              ...
              <div class="col-md-8">
                <h1 class="text-center"> <b>About JooteKhareedo.com</b> </h1>
                <p>&nbsp&nbsp&nbsp&nbsp<b>India’s Shoes Shopping Site <b>JooteKhareedo</b>’s vision is to create India’s most reliable and frictionless commerce ecosystem that creates life-changing experiences for buyers and sellers.</b></p>  
              </div>
            </div>
          </div>
